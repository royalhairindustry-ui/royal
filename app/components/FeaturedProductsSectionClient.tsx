    ...
    >
      ...
      <div className="mt-3 flex flex-col items-center text-center md:mt-6">
        {product.category?.name && (
          <p className="text-[10px] md:text-[12px] font-medium tracking-[0.2em] text-zinc-500 uppercase mb-2 italic">
            {product.category.name}
          </p>
        )}
        <h3 className="text-[14px] md:text-[18px] font-bold tracking-tight text-black flex-1 line-clamp-2 uppercase">
